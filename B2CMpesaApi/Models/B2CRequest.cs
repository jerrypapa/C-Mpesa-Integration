...
namespace B2CMpesaApi.Models
{
    public class B2CRequest
    {
        ...
        /// processing of the payment request.
        /// </param>
        /*public B2CRequest(string intiatorName, string securityCredential, string commandId, string amount, string partyA, string partyB, string remarks, string occasion, string queueTimeoutUrl, string resultUrl)
        {
